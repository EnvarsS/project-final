...
2. **Винесення чутливих даних у змінні оточення** — логін/пароль БД, OAuth2-ключі та налаштування пошти винесено з application.yaml у .env файл.

3. **Перехід на H2 для тестів** — тести тепер використовують H2-database замість PostgreSQL. Додано тестові дані для H2.

5. **Рефакторинг `FileUtil#upload`** — метод переписано з використанням сучасного Java NIO API.
